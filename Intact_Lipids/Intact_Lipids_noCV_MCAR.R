...
MCAR_simulation <- function(data, missing_percentage) {
  ...
  #get indices for Visit 1 and Visit 2
  ...
  for (col in 6:ncol(data_copy)) {
    ...
    #number of missing values to introduce in total and per visit
    total_rows <- nrow(data_copy)
    total_missing <- round(total_rows * missing_percentage)
    missing_per_visit <- floor(total_missing / 2)
    
    #random missingness to v1
    if (missing_per_visit > 0 && length(v1_indices) > 0) {
      v1_valid <- v1_indices[!is.na(data_copy[v1_indices, col])]
      v1_missing_indices <- sample(v1_valid, min(missing_per_visit, length(v1_valid)))
      data_copy[v1_missing_indices, col] <- NA
    }
    
    #apply random missingness to v2
    if (missing_per_visit > 0 && length(v2_indices) > 0) {
      v2_valid <- v2_indices[!is.na(data_copy[v2_indices, col])]
      v2_missing_indices <- sample(v2_valid, min(missing_per_visit, length(v2_valid)))
...
data_10pct <- MCAR_simulation(data, 0.1) #10% missing values
data_20pct <- MCAR_simulation(data, 0.2) #20% missing values
data_30pct <- MCAR_simulation(data, 0.3) #30% missing values
data_40pct <- MCAR_simulation(data, 0.4) #40% missing values
...
plot_missing_values(data_10pct, "Missing Data Pattern (10% MCAR)")
plot_missing_values(data_20pct, "Missing Data Pattern (20% MCAR)")
plot_missing_values(data_30pct, "Missing Data Pattern (30% MCAR)")
plot_missing_values(data_40pct, "Missing Data Pattern (40% MCAR)")
...
#open pdf device
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/Lipid_Comparison_Boxplots.pdf", width = 14, height = 10)
...
#Half-min
#visit 1
shapiro1_halfmin10 <- shapiro_test(halfmin_10pct_v1) #1/274
shapiro1_halfmin20 <- shapiro_test(halfmin_20pct_v1) #1/274
shapiro1_halfmin30 <- shapiro_test(halfmin_30pct_v1) #1/274
shapiro1_halfmin40 <- shapiro_test(halfmin_40pct_v1) #39/274
#visit 2
shapiro2_halfmin10 <- shapiro_test(halfmin_10pct_v2) #4/274
shapiro2_halfmin20 <- shapiro_test(halfmin_20pct_v2) #0/274
shapiro2_halfmin30 <- shapiro_test(halfmin_30pct_v2) #6/274
shapiro2_halfmin40 <- shapiro_test(halfmin_40pct_v2) #1/274

#knn
#visit 1
shapiro1_knn10 <- shapiro_test(knn_10pct_v1) #7/274
shapiro1_knn20 <- shapiro_test(knn_20pct_v1) #42/274
shapiro1_knn30 <- shapiro_test(knn_30pct_v1) #74/274
shapiro1_knn40 <- shapiro_test(knn_40pct_v1) #139/274
#visit 2
shapiro2_knn10 <- shapiro_test(knn_10pct_v2) #11/274
shapiro2_knn20 <- shapiro_test(knn_20pct_v2) #45/274
shapiro2_knn30 <- shapiro_test(knn_30pct_v2) #65/274
shapiro2_knn40 <- shapiro_test(knn_40pct_v2) #183/274

#RF
#visit 1
shaprio1_rf10 <- shapiro_test(rf_10pct_v1) #5/274
shaprio1_rf20 <- shapiro_test(rf_20pct_v1) #15/274
shaprio1_rf30 <- shapiro_test(rf_30pct_v1) #4/274
shaprio1_rf40 <- shapiro_test(rf_40pct_v1) #26/274
#visit 2
shaprio2_rf10 <- shapiro_test(rf_10pct_v2) #4/274
shaprio2_rf20 <- shapiro_test(rf_20pct_v2) #2/274
shaprio2_rf30 <- shapiro_test(rf_30pct_v2) #2/274
shaprio2_rf40 <- shapiro_test(rf_40pct_v2) #4/274

#QRILC
#visit1
shapiro1_qrilc10 <- shapiro_test(qrilc_10pct_v1) #3/274
shapiro1_qrilc20 <- shapiro_test(qrilc_20pct_v1) #5/174
shapiro1_qrilc30 <- shapiro_test(qrilc_30pct_v1) #6/274
shapiro1_qrilc40 <- shapiro_test(qrilc_40pct_v1) #45/274
#visit2
shapiro2_qrilc10 <- shapiro_test(qrilc_10pct_v2) #3/274
shapiro2_qrilc20 <- shapiro_test(qrilc_20pct_v2) #3/174
shapiro2_qrilc30 <- shapiro_test(qrilc_30pct_v2) #6/274
shapiro2_qrilc40 <- shapiro_test(qrilc_40pct_v2) #1/274

pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/Shapiro_Wilk.pdf", width = 14, height = 10)
...
#KNN
visit_KNN10pct_res <- visit_statistical_tests(knn_10pct_tot) #0 W and 0 T
visit_KNN20pct_res <- visit_statistical_tests(knn_20pct_tot) #0 W and 0 T
visit_KNN30pct_res <- visit_statistical_tests(knn_30pct_tot) #0 W and 19 T
visit_KNN40pct_res <- visit_statistical_tests(knn_40pct_tot) #0 W and 58 T
#RF
visit_RF10pct_res <- visit_statistical_tests(rf_10pct_tot) #0 W and 0 T
visit_RF20pct_res <- visit_statistical_tests(rf_20pct_tot) #0 W and 1 T
visit_RF30pct_res <- visit_statistical_tests(rf_30pct_tot) #0 W and 11 T
visit_RF40pct_res <- visit_statistical_tests(rf_40pct_tot) #50 W and 27 T
#QRILC
...
visit_QRILC30pct_res <- visit_statistical_tests(qrilc_30pct_tot) #0 and 2
visit_QRILC40pct_res <- visit_statistical_tests(qrilc_40pct_tot) #0 and 0
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/T_Test_Wilcox.pdf", width = 14, height = 10)
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/NRMSE.pdf", width = 14, height = 10)
...
#convert MCAR as factor
nrmse_data1$MCAR_proportion <- factor(nrmse_data1$MCAR_proportion)
...
#convert MCAR as factor
nrmse_data2$MCAR_proportion <- factor(nrmse_data2$MCAR_proportion)
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/NMD.pdf", width = 14, height = 10)
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/Distr_Halfmin.pdf", width = 14, height = 10)
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/Distr_KNN.pdf", width = 14, height = 10)
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/Distr_RF.pdf", width = 14, height = 10)
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/Distr_QRILC.pdf", width = 14, height = 10)
...
#Visit 1
anova_visit1 <- aov(log_NRMSE ~ Imputation_Method * MCAR_proportion, data = nrmse_data1)
summary(anova_visit1)  

#ANOVA for Visit 2
anova_visit2 <- aov(log_NRMSE ~ Imputation_Method * MCAR_proportion, data = nrmse_data2)
...
pdf("/Users/marcinebessire/Desktop/Master_Thesis/Intact_Lipids/no_CV/MCAR/ANOVA_res.pdf", width = 14, height = 10)
